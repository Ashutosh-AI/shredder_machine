...
def drawsafelines(image_np, Orientation, Line_Perc1, Line_Perc2):
    ...
    if(Orientation == "bt"):
        ...
        cv2.line(image_np, pt1=(0, Line_Position1), pt2=(image_np.shape[1], Line_Position1), color=(0,0,255), thickness=2, lineType=8, shift=0)
        cv2.line(image_np, pt1=(0, Line_Position2), pt2=(image_np.shape[1], Line_Position2), color=(255,0,0), thickness=2, lineType=8, shift=0)
